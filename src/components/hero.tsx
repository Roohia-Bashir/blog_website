...
export default async function Hero() {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      {/* Main content */}
      <div className="relative min-h-[796px] bg-[#646469] px-4 py-16 md:px-8 lg:px-16">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <Link 
                href={`/blog/${id}`}
                className="inline-block px-12 py-4 bg-buttonColor text-buttonTextColor font-bold rounded-lg hover:bg-white hover:text-buttonHoverTextColor transition-colors duration-300"
              >
                Read more
              </Link>
            </div>
